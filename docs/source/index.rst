...
Please contact kgagnon@lakeheadu.ca for information concerning ``aiida-aimall`` and the `AiiDA mailing list <http://www.aiida.net/mailing-list/>`_ for questions concerning ``aiida``.
